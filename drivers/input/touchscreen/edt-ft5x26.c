					 ...
					 const struct i2c_device_id *id)
{
	...
	tsdata->irq = devm_gpiod_get_optional(&client->dev,"irq", GPIOD_IN);	
	gpiod_direction_input(tsdata->irq);
	gpiod_get_value(tsdata->irq);
...
static const struct i2c_device_id edt_ft5x06_ts_id[] = {
	{ .name = "edt-ft5x26", .driver_data = (long)&edt_ft5x06_data },
	{ /* sentinel */ }
};
